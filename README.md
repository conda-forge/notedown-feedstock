About notedown-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/notedown-feedstock/blob/main/LICENSE.txt)
...
Development: http://github.com/aaren/notedown

Documentation: http://github.com/aaren/notedown
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5363&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/notedown-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `notedown` can be installed with `conda`:
...
```
mamba install notedown
```

It is possible to list all of the versions of `notedown` available on your platform with `conda`:
...
```
mamba search notedown --channel conda-forge
```
...
mamba repoquery search notedown --channel conda-forge

# List packages depending on `notedown`:
mamba repoquery whoneeds notedown --channel conda-forge

# List dependencies of `notedown`:
mamba repoquery depends notedown --channel conda-forge
```
